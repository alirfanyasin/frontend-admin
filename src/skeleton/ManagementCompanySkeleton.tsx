...
const ManagementCompanySkeleton: React.FC = () => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6">
          <div>
            <div className={`h-8 w-56 rounded mb-2 ${shimmerClass}`}></div>
            <div className={`h-4 w-80 rounded ${shimmerClass}`}></div>
          </div>
        </div>
        ...
        {/* Stats Cards Skeleton - 4 cards for company page */}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div
                          className={`h-4 w-32 rounded mb-2 ${shimmerClass}`}
                        ></div>
                        <div
                  ...
                  <div className="space-y-2">
                    <div className={`h-4 w-52 rounded ${shimmerClass}`}></div>
                    <div className={`h-4 w-44 rounded ${shimmerClass}`}></div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-700">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left">
                    <div className={`h-4 w-14 rounded ${shimmerClass}`}></div>
                  </th>
                  <th className="px-6 py-3 text-left">
                  ...
                  <tr key={index}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div
                            className={`h-4 w-32 rounded mb-1 ${shimmerClass}`}
                          ></div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div
                        className={`h-4 w-36 rounded mb-1 ${shimmerClass}`}
                      ></div>
                      <div className={`h-3 w-28 rounded ${shimmerClass}`}></div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div
                        className={`h-4 w-24 rounded mb-1 ${shimmerClass}`}
                      ></div>
          ...
          <div className="px-4 sm:px-6 py-3 border-t border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className={`h-4 w-56 rounded ${shimmerClass}`}></div>
...
export default ManagementCompanySkeleton;
